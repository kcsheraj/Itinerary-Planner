...
function EventModal({
      ...
      if (autocompleteRef.current) {
        ...
        autocompleteRef.current.addListener("place_changed", () => {
          ...
          if (!place || !place.geometry) {
            console.log(
              "No geometry information available for selected place:",
              place?.name || "unknown"
            );
  ...
  useEffect(() => {
    if (
      ...
      mapRef.current &&
      editForm.address &&
      event?.address !== editForm.address
    ) {
  ...
  const handleInputChange = (e) => {
    ...
    if (name === "cost" || name === "duration") {
      // Remove leading zeros and parse as number, but allow empty string for user clearing input
      ...
      // Allow empty string for time field
      setEditForm({
        ...editForm,
        time: value,
      });
          ...
          <div className="address-autocomplete-container">
            ...
            {previewMapVisible && mapLoaded && (
              <div className="address-map-preview">
                ...
                <div className="preview-map-instructions">
              ...
              {colorOptions.map((color, index) => (
                <button
                  ...
                  className={`color-option ${
                    editForm.bubbleClass === color.value ? "selected" : ""
                  }`}
    ...
    <div className="view-mode-container">
      <div className="modal-header">
        <div
          ...
          style={{ backgroundColor: getColorByClass(event.bubbleClass) }}
        >
